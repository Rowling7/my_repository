    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSettlement.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                intent = new Intent(ShoplistActivity.this, SettlementActivity.class);
        ...
        imgMy.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = null;
                intent = new Intent(ShoplistActivity.this,MyActivity.class);
                startActivity(intent);
            }
        });
        ...
        imgCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = null;
                intent = new Intent(ShoplistActivity.this,ShoplistActivity.class);
                startActivity(intent);
            }
        });
    ...
    protected void initData(){
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                AlertDialog dialog;
                AlertDialog.Builder builder=new AlertDialog.Builder(ShoplistActivity.this).setMessage("是否删除此商品？")
